...
log "Używam pio: $PIO"
build_one "ESP32" "$ESP32_PROJECT_DIR" "esp32dev" "$BUILD_DIR/esp32"
build_one "ESP32-C6" "$C6_PROJECT_DIR" "esp32c6" "$BUILD_DIR/esp32c6"
build_one "Sonoff 4CH" "$SONOFF_PROJECT_DIR" "sonoff4ch" "$BUILD_DIR/sonoff4ch"
...
echo "  ESP32 FW:    $LATEST_DIR/esp32/firmware.bin"
echo "  ESP32 FS:    $LATEST_DIR/esp32/littlefs.bin"
echo "  ESP32-C6 FW: $LATEST_DIR/esp32c6/firmware.bin"
echo "  ESP32-C6 FS: $LATEST_DIR/esp32c6/littlefs.bin"
echo "  Sonoff FW:   $LATEST_DIR/sonoff4ch/firmware.bin"
