...
inline void Programs::logScheduleSkipped(const String& zoneObj, bool weatherAutoEnabled, int baseDuration, float rain24h, float tempC, int humidityPct, float windKmh, const String& reasonCode, const String& reasonText) {
  if (!logs) return;
...
inline void Programs::pushScheduleSkipped(const String& zoneObj, bool weatherAutoEnabled, int baseDuration, float rain24h, float tempC, const String& reasonCode, const String& reasonText) {
  (void)weatherAutoEnabled;
  (void)baseDuration;
  (void)rain24h;
  (void)tempC;
...
inline void Programs::logScheduleStarted(const String& zoneObj, bool weatherAutoEnabled, int baseDuration, int actualDuration, int wateringPercent, float rain24h, float tempC, int humidityPct, float windKmh, const String& explain) {
  if (!logs) return;
  (void)weatherAutoEnabled;
  (void)baseDuration;
...
inline void Programs::pushScheduleStarted(const String& zoneObj, bool weatherAutoEnabled, int baseDuration, int actualDuration, int wateringPercent, float rain24h, float tempC, int humidityPct, float windKmh) {
  (void)weatherAutoEnabled;
  (void)baseDuration;
  (void)wateringPercent;
  (void)rain24h;
...
inline void Programs::logZoneStarted(const String& zoneObj, int actualDuration) {
  if (!logs) return;
  logs->add(EventMessages::logSentence("HARMONOGRAM", EventMessages::zoneStarted(zoneObj, actualDuration)));
}
